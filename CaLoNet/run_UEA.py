...
parser.add_argument('--subgraph_size',type=int,default=2,help='k')##注意k需要小于num_nodes#20
...
def test(epoch):
    ...
    for batch_id, (x,z, y) in enumerate(test_loader):
...
def train(optimizer):
    ...
    for epoch in range(n_epochs):
        ...
        for batch_id, (x, z,y) in enumerate(train_loader):
